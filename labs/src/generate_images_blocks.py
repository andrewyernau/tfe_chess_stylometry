#!/usr/bin/env python3
"""
Generación sincronizada de imágenes con fragmentación en bloques.

Genera tableros y heatmaps divididos en bloques temporales para análisis.
"""
...
from generate_decision_heatmaps import GrayscaleHeatmapGenerator
