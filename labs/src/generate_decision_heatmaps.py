#!/usr/bin/env python3
"""
Generador de mapas de calor de tiempo de decisión.

Heatmaps en escala de grises: negro = decisión rápida, blanco = decisión lenta.
Soporte para fragmentación en bloques temporales.
"""
...
class GrayscaleHeatmapGenerator:
    ...
    Negro (0) = decisión rápida
    Blanco (255) = decisión lenta
    """
